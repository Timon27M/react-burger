...
import { getBurgerConstructorIngradients, getTotalPice } from "../../services/selectors";
// import { ingradientsTypes } from "../../utils/constants";
import { deleteIngredient, updateTotalPrice } from "../../services/actions/burgerConstructor";
import {
  ConstructorElement,
  DragIcon,
  CurrencyIcon,
      ...
      <div className={`mt-25 ml-10 ${styles.mainContent}`}>
        ...
        (<div className={styles.container}>
          <div className={`pl-8 pr-4`}>
            {ingradientBun && <ConstructorElement
          ...
          <p className={`mt-10 text text_type_main-medium`}>Перетащите ингредиенты и булки для составления бургера</p>
        )
        }
